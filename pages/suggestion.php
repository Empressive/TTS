...
<form method="post" action="scripts/suggestion.php">
    <div id="support_title"><textarea class="subject" placeholder="Тема вашего предложения" maxlength="30" name="subject" required></textarea></div>
    ...
    <div id="suggestion_button"><input type="submit" value="Отправить"></div>
</form>