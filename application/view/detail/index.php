<form action='<?= URL . 'tickets/edit/' . $items['id'] . '/'; ?>' method='post'>
    ...
    <table width='30%' align='left' border='1' id='detail_table'>
        ...
        <tr>
            <td>Дом:</td>
            <td><input type='text' <?= $access ?> value='<?= $items['house'] ?>' name='house'></td>
        </tr>
        <tr>
            <td>Подъезд:</td>
            <td><input type='text' <?= $access ?> value='<?= $items['driveway'] ?>' name='driveway'></td>
        </tr>
        <tr>
            <td>Этаж:</td>
            <td><input type='text' <?= $access ?> value='<?= $items['floor'] ?>' name='floor'></td>
        </tr>
        <tr>
            <td>Квартира:</td>
            <td><input type='text' <?= $access ?> value='<?= $items['flat'] ?>' name='flat'></td>
        </tr>
        <tr>
            <td>Телефон:</td>
            <td><input type='text' id='phone' <?= $access ?> value='<?= $items['phone'] ?>' name='phone'></td>
        </tr>
        <tr>
