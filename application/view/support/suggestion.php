...
<form method='post' action='<?echo URL . 'support/insert/';?>'>
    <div id='support_title'><input type='text' placeholder='Тема вашего предложения' maxlength='30' name='subject' required></div>
